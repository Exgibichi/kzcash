...
public:
    CMainParams()
    {
        ...
        consensus.nBudgetPaymentsStartBlock = 3224; // actual historical value
        consensus.nBudgetPaymentsCycleBlocks = 24; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        ...
        //     boost::assign::map_list_of(1250, uint256S("0x0000001d0090a0ad135fed43720b1d745867a15e6ee9b7d9e5d51fed98a0a13e"))(1400, uint256S("0x00000018493f238c926a8102b7121f0834de61e0e44f9a93e69ed64475e30b8e"))(1637, uint256S("0x000000009cf0be5faf6fdcd4f3e3a6392abee2f47c81f0189ef4643aa9463976"))(2911, uint256S("0x000000000000b4ac6491fd56c5c2f0494c5130e58b62076bee10fb1f08ef00f8"))(4490, uint256S("0x0000000000008f2db7249096215415313d5cbe58656f52cae24b0bcbc70573e5"))(15883, uint256S("0x0000000000003794d5680c5534b73151a807d0ec9c563fec3dd4d9422c40f694"))(16814, uint256S("0x0000000000003a045783c062a8f7dbacc74120a1b10b576550c25b1c93ba478c"))(17866, uint256S("0x000000000000413546251d72ae4f813360ffa7d84f00ac989b74e2bb26b65a0e")),
...
public:
    CTestNetParams()
    {
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of(0, uint256S("0x0000083f8eb64445c14163e8b28cea2214f109e3ea2bdbb7d77b2192bb75fbc7")),
...
public:
    CRegTestParams()
    {
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of(0, uint256S("0x224815ad6d4aab4c512837e4beeae143c60bd29af6596c461ec7035de2f6219d")),
            0,
            0,
            0};
